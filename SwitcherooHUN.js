(function(global) {
    ...
    function Switcheroo(selector = '#switcheroo', options = {}) {
        ...
        var defaults = {
            ...
            deleteIcon: `×`,
            addIcon: `+`,
            errorMsg: 'Hiba történt a Switcheroo használata során.',
            confirmMsg: 'Biztosan profilt szeretnél váltani?',
            modal: {}
        };
    ...
    Switcheroo.prototype.buildSwitcheroo = function() {
        ...
        login.appendChild(this.createTooltip('Adj hozzá új profilt'))
    ...
    Switcheroo.prototype.createLogoElement = function(wrapper) {
        ...
        logo.appendChild(this.createTooltip('Főoldal'));
